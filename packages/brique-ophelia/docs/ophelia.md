---
title: 'Ophélia v3.0 : Documentation de l''Agente Inseme'
...
## 7. Fusion Sémantique et Fenêtre Contextuelle

Pour les environnements complexes (comme la brique Cyrnea), Ophélia utilise un moteur de **Fusion
Sémantique** :

- **Capture en continu** : Les "capteurs sémantiques" (voix, messages, signaux visuels) envoient des
  états atomiques au module `semantic-fusion.js`.
- **Fenêtre Glissante** : Le système agrège les 10 dernières minutes d'activité pour produire un
  "Instantané du Moment Présent".
- **Enrichissement** : Ophélia reçoit automatiquement cet instantané (`semantic_window`) qui inclut
  :
  - Les thèmes dominants de la conversation.
  - L'état émotionnel du groupe (ex: calme, animé, tendu).
  - Les questions en suspens.
- **Bénéfice** : Cela permet à Ophélia de rester pertinente sans avoir à relire l'intégralité des
  logs bruts, en se concentrant sur la "vibration" actuelle de la salle.

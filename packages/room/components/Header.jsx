        ...
        <div className="flex items-center gap-4">
          {user && (
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={onSignOut}
                className="p-2.5 rounded-xl bg-white/5 hover:bg-mondrian-red/10 text-white/40 hover:text-mondrian-red border border-white/10 hover:border-mondrian-red/20 transition-all"
                title="Déconnexion"
              >

...
- **Blog Editor**: A streamlined interface for writing and publishing articles.
- **Gazette Layout**: A professional, newspaper-style layout for the community's front page.
- **Curator Leaderboard**: Gamification elements to encourage quality local curation.
- **AI Tools**: Semantic search and reading tools for the blog archives.
...
```
packages/brique-blog/
├── src/
│   ├── components/    # Gazette layouts and curator leaderboards
│   ├── edge/          # AI tools for reading and searching blog posts
│   └── pages/         # Blog editing, viewing, and gazette pages
